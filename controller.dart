...
class WalletController extends GetxController {
  ...
  Future<void> getWalletData() async {
    ...
    try {
      ...
      String url = 'https://api.aagyo.in/api/v1/user-wallet/transaction?limit=$limit&page=$page';
      ...
      if (response.statusCode == 200) {
        ...
        List<TransactionWalletData> newTransactions = (jsonData['result']['data'] as List)
